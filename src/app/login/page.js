    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-pink-100 via-purple-100 to-indigo-100">
      <div className="bg-white p-8 rounded-lg shadow-xl max-w-md w-full space-y-8">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 bg-white px-4 py-3 border border-gray-300 rounded-md shadow-sm hover:bg-gray-50 transition-colors"
        >
